...
The landscape configuration will follow a hierarchical CNCF-style structure. Each root category node will contain subcategories, which will contain individual items:
